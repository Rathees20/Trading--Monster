...
function StepCard({ icon, title, body }) {
  return (
    <div className="relative flex h-[170px] w-full flex-col items-center justify-center gap-3 rounded-[26px] border border-[#FFB41480] bg-[#FFB4141A] px-6 py-6 text-center shadow-[0_0_0_1px_rgba(255,180,20,0.18),0_0_60px_rgba(255,180,20,0.06)] backdrop-blur transition hover:scale-[1.03]">
