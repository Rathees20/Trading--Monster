        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 min-h-[80vh]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-white/10 pb-6 mb-8 gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
                        Blog <span className="text-amber-450">Manager</span>
                    </h1>
                    <p className="text-sm text-white/60 mt-1">
                        Publish articles, configure layouts, and update content in real-time.
                    </p>
                </div>
            ...
            {showFormModal && (
                <div className="fixed inset-0 z-50 overflow-y-auto bg-black/90 backdrop-blur-md flex items-center justify-center p-4">
                    <div className="w-full max-w-6xl rounded-3xl border border-white/10 bg-neutral-950 p-6 md:p-8 shadow-2xl relative flex flex-col h-[90vh]">
                        {/* Header */}
                        <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-6">
                            <div>
                                ...
                                <p className="text-xs text-white/50 mt-0.5">
                                    {editingPost ? `Editing ID: ${formId}` : "Adding to blog catalog"}
                                </p>
                            </div>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white focus:ring-1 focus:ring-amber-500 outline-none"
                                                placeholder="e.g. Spotting institutional order blocks like a pro"
                                                required
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white focus:ring-1 focus:ring-amber-500 outline-none h-20 resize-none"
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className="w-full bg-neutral-900 border border-white/10 rounded-xl px-3 py-2.5 text-xs text-white focus:ring-1 focus:ring-amber-500 outline-none"
                                                >
                                                    {categories.map(cat => (
                                                        <option key={cat} value={cat}>{cat}</option>
                                                    ))}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-4 border border-white/5 bg-white/5 p-3.5 rounded-xl">
                                    ...
                                    <div className="space-y-4 flex flex-col">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2 text-xs text-white focus:ring-1 focus:ring-amber-500 outline-none file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-amber-500/10 file:text-amber-450 hover:file:bg-amber-500/20"
                                            />
                                            {formImage && (
                                                <div className="mt-3 relative w-full h-32 rounded-xl overflow-hidden border border-white/10 group">
                                                    ...
                                                    <button type="button" onClick={() => setFormImage("")} className="absolute top-2 right-2 bg-black/70 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 hover:bg-red-500 transition-all">✕</button>
                                                </div>
                                            )}
                                            {/* Quick Pick Stock Images */}
                                            <div className="mt-3">
                                                <span className="text-[10px] font-semibold text-white/40 block mb-1.5">Or choose a premium stock photo:</span>
